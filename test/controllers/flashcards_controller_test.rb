...
class FlashcardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flashcard" do
    assert_difference("Flashcard.count") do
      post flashcards_url, params: { flashcard: { answer: @flashcard.answer, deck_id: @flashcard.deck_id, question: @flashcard.question, user_id: @flashcard.user_id } }
    end
  ...
  test "should update flashcard" do
    patch flashcard_url(@flashcard), params: { flashcard: { answer: @flashcard.answer, deck_id: @flashcard.deck_id, question: @flashcard.question, user_id: @flashcard.user_id } }
